...
describe('The menu', function(){
        ...
        it('menu is hidden by default', function() {
         ...
         it('menu visibility on click', function () {
            //it is visibil when the menu icon is clicked
            $(".menu-icon-link").click();
            expect($('body').hasClass("menu-hidden")).toBe(false);
            //it is hide when the menu icon is clicked
            $(".menu-icon-link").click();
            expect($('body').hasClass("menu-hidden")).toBe(true);
        });
...
//check if two entry are not equal ;)
            it('check if two feeds are differnt', function(done){
                loadFeed(1, function(){
                feedafter = $('.after').html();
